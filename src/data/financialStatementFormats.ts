...
export const CORPORATE_BS_FORMAT: FSLineItem[] = [
  ...
  { srNo: '(a)', particulars: 'Share Capital', level: 2, fsArea: 'Equity' },
  { srNo: '(b)', particulars: 'Reserves and Surplus', level: 2, fsArea: 'Reserves' },
  { srNo: '(c)', particulars: 'Money received against share warrants', level: 2, fsArea: 'Share Warrants' },
  { particulars: '', level: 1, isTotal: true },
  { particulars: '(2) Share application money pending allotment', level: 1, fsArea: 'Share Application' },
  ...
  { particulars: '(A) Micro and Small Enterprises', level: 3, fsArea: 'Payables MSME' },
  { particulars: '(B) Others', level: 3, fsArea: 'Payables' },
  ...
  { particulars: '(i) Property, Plant and Equipment', level: 3, fsArea: 'Fixed Assets' },
  { particulars: '(ii) Intangible assets', level: 3, fsArea: 'Intangible Assets' },
  { particulars: '(iii) Capital work-in-progress', level: 3, fsArea: 'CWIP' },
  { particulars: '(iv) Intangible assets under development', level: 3, fsArea: 'Intangible Under Dev' },
...
export const CORPORATE_PL_FORMAT: FSLineItem[] = [
  ...
  { srNo: '(a)', particulars: 'Cost of materials consumed', level: 2, fsArea: 'Cost of Materials' },
  { srNo: '(b)', particulars: 'Purchases of Stock-in-Trade', level: 2, fsArea: 'Purchases' },
  { srNo: '(c)', particulars: 'Changes in inventories of finished goods, WIP and Stock-in-Trade', level: 2, fsArea: 'Inventory Change' },
  { srNo: '(d)', particulars: 'Employee benefits expense', level: 2, fsArea: 'Employee Benefits' },
  { srNo: '(e)', particulars: 'Finance costs', level: 2, fsArea: 'Finance' },
  { srNo: '(f)', particulars: 'Depreciation and amortization expense', level: 2, fsArea: 'Depreciation' },
  { srNo: '(g)', particulars: 'Other expenses', level: 2, fsArea: 'Other Expenses' },
  ...
  { srNo: '(b)', particulars: 'Deferred tax', level: 2, fsArea: 'Deferred Tax Expense' },
...
export const NON_CORPORATE_PL_FORMAT: FSLineItem[] = [
  ...
  { srNo: 'X', particulars: "Owners' remuneration", level: 1, fsArea: 'Partners Remuneration' },
